...
("4. Todos los nodos (elementos y contenido) de los coches de 
la marca Renault."),
...
("7. El contenido de la descripción de las reparaciones 
realizadas al coche de matrícula: 4444B."),
//reparacion[matricula="4444B"]/descripcion/text(),
("8. El contenido de la descripción de la reparación de código 
J0005."),
...
("13. Selecciona todos los elementos del coche de la marca Seat 
con color Rojo."),
...
("15. Contenido de la descripción de las reparaciones realizadas 
con fecha de entrada 2013/06/06."),
...
("20. Suma de las horas de reparación del coche de matrícula 
4444B."),
sum(//reparacion[matricula="4444B"]/horas/text()),
