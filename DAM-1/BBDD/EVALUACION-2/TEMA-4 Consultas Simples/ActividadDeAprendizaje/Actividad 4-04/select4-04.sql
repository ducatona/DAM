...
select Language,IsOfficial,Percentage,CountryCode from countrylanguage where IsOfficial="F" && Percentage>=40;
...
select distinct Language,IsOfficial from countrylanguage where IsOfficial="F" and Percentage between 5 and 10 order by Language;
...
select Name,Population,Continent from country where Continent in ("Asia","Africa","Europa") and Population>=50000000 order by Population desc;
...
select Name,Population,Continent from country where Continent in ("Asia","Africa") and Population between 10000000 and 50000000 
order by Population desc limit 5;

/*5.- Obtén los nombres y continente de todos los países de Asia que no tienen registrado 
año de independencia.*/
select Name,Continent,IndepYear from country where Continent="Asia" and IndepYear is null;
...
select Name,Population,Region,GovernmentForm,Continent,IndepYear,GNPOld from country where Continent="Asia" 
and (IndepYear is null and GNPOld is null);
...
select Name,Population,Continent,Population from country where not Continent="Europe" and (Name like "N%" or Name like "S%") and Population>2000000;
...
select Name,Population/SurfaceArea as Densidad from country where Population/SurfaceArea  between 50 and 60 order by Name;

/*10.- Obtén el nombre de todos los países que se han independizado en el siglo XX junto 
con su año de independencia*/

select Name,IndepYear from country where IndepYear between 1900 and 2000 order by IndepYear asc;
...
select Name,Continent,IndepYear from country where IndepYear is not null order by IndepYear asc limit 5;

/*12.- Obtén los nombres de todos los países cuyo nombre comience y termine con la letra 
A y contenga la letra E.*/

select Name from country where Name like "a%a" and Name like "%e%";
