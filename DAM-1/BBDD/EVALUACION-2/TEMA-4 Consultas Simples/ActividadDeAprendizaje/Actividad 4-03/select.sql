...
select usuario,cancion,fecha from votos where fecha<20180000 order by fecha;

/*3.- Obtén los datos de todos los votos realizados el día 2 de enero de 2018*/
select usuario,cancion,fecha from votos where fecha=20180102 order by fecha;
...
select usuario,cancion,fecha from votos where fecha=curdate() order by fecha;
